...
/* package AntColony-0.1.0.0 */
#ifndef VERSION_AntColony
#define VERSION_AntColony "0.1.0.0"
#endif /* VERSION_AntColony */
#ifndef MIN_VERSION_AntColony
#define MIN_VERSION_AntColony(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_AntColony */
...
#define CURRENT_COMPONENT_ID "AntColony-0.1.0.0-inplace-AntColony"
