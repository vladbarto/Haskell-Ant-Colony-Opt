...
/* package control-search-local-0.1.0.0 */
#ifndef VERSION_control_search_local
#define VERSION_control_search_local "0.1.0.0"
#endif /* VERSION_control_search_local */
#ifndef MIN_VERSION_control_search_local
#define MIN_VERSION_control_search_local(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_control_search_local */
...
#define CURRENT_PACKAGE_KEY "control-search-local-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "control-search-local-0.1.0.0-inplace"
